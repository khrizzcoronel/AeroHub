...
export const appRoutes: Route[] = [
  ...
  // vistas de identidad/tenancy que viven fuera del menu dinamico).
  {
    ...
    children: [
      ...
      { path: 'api-keys', component: ApiKeyList, data: { title: 'Llaves de API e Integraciones' } },
      ...
      { path: 'billing/facturas', component: PanelFacturas, data: { title: 'Facturación e Ingresos' } },
      {
